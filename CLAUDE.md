...
An on-demand LLM summary of an already-computed report, rendered as the first "AI Advisor Notes" section in `ReportDisplay.tsx` behind a Generate button. Three rules define it:
